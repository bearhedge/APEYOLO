 ...
 * DeFi Page
 *
 * On-chain attestation of trading track records on Solana.
 * Simplified design with 3 sections: Create Attestation, Attestations Table, Info Box
 */
  ...
  const handlePreview = async () => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        console.error('Failed to generate attestation:', result.error);
      }
    } catch (error) {
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-silver text-sm mt-1">
            On-chain attestation of your trading track record
          </p>
        </div>

        {/* Not Connected State - Centered CTA */}
        {!connected && (
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="bg-charcoal rounded-2xl p-8 border border-white/10 max-w-md text-center">
              <div className="w-12 h-12 rounded-full bg-electric/20 flex items-center justify-center mx-auto mb-4">
                <Wallet className="w-6 h-6 text-electric" />
              </div>
              <h2 className="text-xl font-semibold mb-2">Connect Wallet</h2>
              <p className="text-silver text-sm mb-6">
                Connect your Solana wallet to create on-chain attestations of your trading performance.
              </p>
              <WalletMultiButton className="!bg-electric !text-black hover:!bg-electric/90 !rounded-lg !h-12 !px-8 !font-medium !text-base !w-full !justify-center" />
        ...
        {connected && (
          <>
            ...
            <div className="bg-charcoal rounded-2xl p-6 border border-white/10">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-semibold">Create Attestation</h3>
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    {showPeriodDropdown && (
                      <div className="absolute top-full left-0 mt-1 w-full bg-black border border-white/20 rounded-lg shadow-xl z-10 overflow-hidden">
            ...
            {/* Section 2: Attestations Table */}
            <div className="bg-charcoal rounded-2xl p-6 border border-white/10">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold">
                  On-Chain Attestations {attestations.length > 0 && `(${attestations.length})`}
                </h3>
                {attestationsLoading && (
              ...
              {attestations.length > 0 ? (
                <DataTable data={attestations} columns={attestationColumns} />
              ) : (
                <div className="text-center py-12">
                  <ShieldCheck className="w-12 h-12 text-zinc-600 mx-auto mb-4" />
                  <p className="text-silver">No attestations yet</p>
                  <p className="text-zinc-500 text-sm mt-1">
                    Create your first attestation to build your on-chain track record
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-charcoal/50 border border-white/5 rounded-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-silver text-sm font-medium mb-1">About On-Chain Attestation</p>
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    Each attestation creates an immutable record on Solana. The hash allows anyone to verify your trading claims.
